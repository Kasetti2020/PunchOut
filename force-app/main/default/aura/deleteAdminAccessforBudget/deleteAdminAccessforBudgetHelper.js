({
	initializeDeleteData : function(component,event,helper,batchId) {
        var action=component.get("c.getDeleteDataBudgetInventory");
        action.setParams({
            "batchid": batchId
        });
    ...
    processUploadingOfData: function(component,event,helper,batchId) {
        ...
        evt.setParams({
            componentDef : "c:BatchMasterForBudgetPlan"
        });
        evt.fire();
       
        var action = component.get("c.deleteRecordForInventoryBudget"); 
        action.setParams({
            "batchid" : batchId
        });
        action.setCallback(this,function (response) {
            ...
            if (state === "SUCCESS") {                
                ...
                if(status){
                   ...
                   var text = 'Data is Successfully Deleted';
