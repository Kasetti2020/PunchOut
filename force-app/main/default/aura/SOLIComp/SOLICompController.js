({
	doint : function(component, event, helper,page) {
        ...
        component.set('v.SOLIList.NewPickValueList','New');
    ...
    selectNewPickValue: function (component, event, helper) {
        //alert('Inside selectNewPickValue');
        //alert('selectNewPickValue::'+component.get('v.selectedValue'));
        component.set('v.SOLIList.NewPickValueList',component.get('v.selectedValue'));
        //alert('selectNewPickValue::'+component.get('v.SOLIList.NewPickValueList'));
        

        
    },
    remarksHandler :function(component, event, helper){
       
        component.set('v.SOLIList.shipmentlineitemRemarks',component.find("mytextarea").get("v.value"));
    }
