({
	doint : function(component, event, helper) {
      ...
      //  if(component.get('v.PORetailerName')=='EILEEN FISHER'){
         // alert(component.get('v.PORetailerGreyOutCheck'));
     /*   if(component.get('v.PORetailerGreyOutCheck')==true){
            component.set('v.POLI_Color_Edit',true);
            component.set('v.POLI_Supply_Qty_Edit',true);
        }
     */
    //If CancelledPo selected greyOut color and supply Qty   added by Raghu on 15/12/2021
    if(component.get("v.POcancelledListViewSelected")==true){
        component.set('v.POLI_Color_Edit',true);
        component.set('v.POLI_Supply_Qty_Edit',true);
    } else{                                                             //if View selectedPo selected else part will get executed
        //added by dharshan 13/12/2021
        if(component.get('v.PORetailerColorGreyOutCheck')==true){
            component.set('v.POLI_Color_Edit',true);
        }

        if(component.get('v.PORetailerSuppltQtyGreyOutCheck')==true){
            component.set('v.POLI_Supply_Qty_Edit',true);
        }
        //ends
    }
