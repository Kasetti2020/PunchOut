({
   doInit:function(component, event, helper){
        ...
        helper.FetchRelatedRetailer(component, event, helper);
    },
    ...
    preferedRetailer: function(component, event, helper){ 
        var selectedRetailer = component.find("retailerId").get("v.value");
        //alert(selectedRetailer);
        helper.FetchRetailerDocnotesAndAttach(component, event, helper,selectedRetailer);
