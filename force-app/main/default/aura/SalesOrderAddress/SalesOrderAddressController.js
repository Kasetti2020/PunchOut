({
    ...
    {
        //console.log("supplierCode>>>>"+JSON.stringify(component.get("v.supplierCode")));
       // console.log("So>>>>"+JSON.stringify(component.get("v.salesOrderObj")));
        helper.toGetCustomerAddess(component, event,helper);
       
       // console.log("mandatory check>>"+JSON.stringify(component.get("v.MandatoryCheck")));
       // alert("test"+component.get("v.DivisionCheck"));
        //alert("test"+component.get("v.SeasonCheck"));
       // alert("test"+component.get("v.SeasonYearCheck"));
    ...
    ConfirmOrder : function(component,event,helper)
    {
        ...
        var salesObj=component.get('v.salesOrderObj');
        var billAddressList = component.get('v.BillAddressList');
        ...
        //alert("SO.Season_Year__c>>>"+SO.Season_Year__c)
        ...
        if(component.get("v.OrderSource")=="PO")
        {
            ...
            helper.unCheckAllPO(component,event,helper);
             helper.tovalidateMOQ(component, event,helper);
