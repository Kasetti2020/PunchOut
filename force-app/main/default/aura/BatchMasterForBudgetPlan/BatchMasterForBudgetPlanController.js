({
    show : function(component, event, helper) {
       ...
       // helper.getBatchStatusPicklist(component, event);
        ...
        helper.prevYear(component, event);
       // helper.month(component, event, helper);
       // helper.getPeriodPicklist(component, event, helper);
    ...
    FilterRecordsBasedOnYear : function(component, event, helper) {
        ...
        //alert('year ::'+year);
          var budPeriod = component.find('periodLstval').get('v.value'); 
       // alert('budPeriod ::'+budPeriod);
        if(year != 'Please Select a Year'){
             component.set('v.loaded', true);
			helper.getfilteredByYear(component,helper,year,company,budPeriod);
     ...
     FilterRecordsBasedOnPeriod : function(component, event, helper) {
			var company = component.find('companyLstval').get('v.value'); 
       // alert('company ::'+company);
       var budPeriod = component.find('periodLstval').get('v.value'); 
       // alert('budPeriod ::'+budPeriod);
  ...
  /*  handleRecordTypeSearchOnChange : function(component, event, helper) {
   ...
   /* handleRecordStatusOnChange : function(component, event, helper) {
    ...
    handlePeriodListOnChange : function(component, event, helper) {
        var periodval = component.find('periodList').get('v.value');  
        //alert('periodval ::'+periodval); 
        var set= component.set("v.selectedValues",periodval);
        
    },
    handleYearOnChange : function(component, event, helper) {
        var year = component.find('yearDynamicList').get('v.value'); 
         var company = component.find('SalesCompanyPicklist').get('v.value'); 
       // alert('company ::'+company);
        if( year != 'Select Budget Year' &&  company != 'Select Company'){
         helper.getPeriodPicklist(component, event, year,company );
        }
        var set= component.set("v.selectedYear",year);
    },    
   ...
   /*   var batchId = event.getSource().get("v.name");
        ...
        evt.setParams({
            componentDef : "c:ViewSalesBudgetErrorSummary",
            componentAttributes: {
                batchId : batchId
            }
        });
   ...
   closeBulkUploadConfirmation: function(component, event, helper) {
    ...
    handleSalesCmpOnChange : function(component, event, helper) {
       ...
       // alert('companysales ::'+companysales);
       var year = component.find('yearDynamicList').get('v.value');
       //  alert('year ::'+year);
         var company = component.find('SalesCompanyPicklist').get('v.value'); 
       // alert('company ::'+company);
        if( year != 'Select Budget Year' &&  company != 'Select Company' && company != null &&  year != '' ){
         helper.getPeriodPicklist(component, event, year,company );
        }
